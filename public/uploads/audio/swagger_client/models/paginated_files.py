...
class PaginatedFiles(object):
    ...
    def __init__(self, values=None, next_link=None, _configuration=None):  # noqa: E501
        """PaginatedFiles - a model defined in Swagger"""  # noqa: E501
    ...
    def next_link(self, next_link):
        """Sets the next_link of this PaginatedFiles.

        A link to the next set of paginated results if there are more entities available; otherwise null.  # noqa: E501

        :param next_link: The next_link of this PaginatedFiles.  # noqa: E501
        :type: str
        """
